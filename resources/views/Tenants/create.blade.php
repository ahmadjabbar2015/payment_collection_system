    ...
    <div class="shadow -lg-3 p-3 mb-5 bg-body rounded mr-4 ml-4">
        ...
        <div class="row mt-2">
            <div class="col">
                ...
                <input type="text" class="form-control" required="required" placeholder="Full name" name="full_name">
            </div>
            <div class="col">
        ...
        <div class="row ">
            <div class="col">
                ...
                <input type="text" class="form-control"required="required"  placeholder="12321" name="number">
            </div>
            <div class="col">
